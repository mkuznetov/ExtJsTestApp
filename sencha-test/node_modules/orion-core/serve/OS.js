...
ST._initOS = function (cfg) {
    var OS = ST.OS,
        userAgent = cfg.navigator.userAgent,
        platform = cfg.navigator.platform,
        nativeDeviceType = cfg.window.deviceType,
        locationSearch = cfg.window.location.search,
        is = (ST.is || (ST.is = {})),
     ...
     *
     */
    ST.os = osEnv = new OS(userAgent, platform);
    ...
    var search = locationSearch.match(/deviceType=(Tablet|Phone)/);
