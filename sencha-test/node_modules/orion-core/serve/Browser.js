...
ST._initBrowser = function (userAgent) {
    ST.userAgent = userAgent.toLowerCase();
    ST.browser = new ST.Browser(userAgent, true);
};
 ...
 */
if (!ST.isSandbox) {
    // if it's a sandobx test, browser will be set later by the context
    ST._initBrowser(navigator.userAgent);
}
