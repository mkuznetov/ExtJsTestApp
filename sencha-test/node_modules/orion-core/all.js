...
var Core = {
    ...
    model: {
        ...
        browser: {
            ...
            SandboxBrowser: require('./lib/model/browser/SandboxBrowser'),
        ...
        test: {
            ...
            SandboxRecorderAgent: require('./lib/model/test/SandboxRecorderAgent'),
    ...
    test: {
        ...
        SandboxRecorderRunner: require('./lib/test/SandboxRecorderRunner'),
        SandboxRunner: require('./lib/test/SandboxRunner'),
        WebDriverRunner: require('./lib/test/WebDriverRunner')
    },
